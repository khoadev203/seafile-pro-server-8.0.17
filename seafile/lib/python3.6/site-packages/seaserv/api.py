...
class SeafileAPI(object):
    ...
    def create_enc_repo(self, repo_id, name, desc, username, magic, random_key, salt, enc_version, storage_id=None):
        return seafserv_threaded_rpc.create_enc_repo(repo_id, name, desc, username, magic, random_key, salt, enc_version, storage_id)
    ...
    def get_org_repo_list(self, org_id, start, limit, order_by=None):
        return seafserv_threaded_rpc.get_org_repo_list(org_id, start, limit, order_by)
