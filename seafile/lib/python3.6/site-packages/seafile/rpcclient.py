...
class SeafServerThreadedRpcClient(NamedPipeClient):
    ...
    @searpc_func("string", ["string", "string", "string", "string", "string", "string", "string", "int", "string"])
    def seafile_create_enc_repo(repo_id, name, desc, owner_email, magic, random_key, salt, enc_version, storage_id):
        pass
    ...
    @searpc_func("objlist", ["int", "int", "int", "string"])
    def seafile_get_org_repo_list(org_id, start, limit, order_by):
        pass
